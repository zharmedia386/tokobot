    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between pb-0 border-0">
                ...
                <a class="btn btn-outline-primary rounded" href="{{ route('purchase_form') }}">
                    ...
                    <table id="datatable" class="table table-striped" data-toggle="data-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>6</td>
                                <td>2011/04/25</td>
                                <td><a class="btn btn-outline-primary rounded" href="{{ route('purchase_form') }}">detail</a></td>
                            </tr>
                            <tr>
