                    ...
                    <div class="tab-pane fade show active" id="tunai" role="tabpanel" aria-labelledby="tunai-tab">
                        ...
                        <div class="card-header d-flex justify-content-between pb-0 border-0">
                            ...
                            <div class="dropdown-container d-flex justify-content-start">
                                ...
                                &nbsp;&nbsp;
                                <a class="btn btn-outline-primary rounded" href="{{ route('sales_form_tunai') }}">
                                    + Tambah Penjualan
                                </a> 
                            </div>
                        </div>
                            ...
                            <table id="datatable sales_form_tunai" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody class="text-center">
                                    @php
                                        $totalPenjualan = 0;
                                    @endphp
                                    @foreach($sales_form_tunai as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <form action="{{ route('sales_tunai_delete', $data->nomor_transaksi) }}" method="post">@csrf
                                                ...
                                                <td><a href="{{ route('sales_tunai_detail', $data->nomor_transaksi) }}" class="btn btn-warning">Detail</a></td>
                                            </tr>
                                            @php
                    ...
                    <div class="tab-pane fade" id="kredit" role="tabpanel" aria-labelledby="kredit-tab">
                        ...
                        <div class="card-header d-flex justify-content-between pb-0 border-0">
                            ...
                            <div class="dropdown-container d-flex justify-content-start">
                                ...
                                &nbsp;&nbsp;
                                <a class="btn btn-outline-primary rounded" href="{{ route('sales_form_kredit') }}">
                                    + Tambah Penjualan
                                </a> 
                            </div>
                        </div>
                                    ...
                                    @foreach($sales_form_kredit as $data)
                                        @if($user_id == $data->user_id)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        <form action="{{ route('sales_kredit_delete', $data->nomor_transaksi) }}" method="post">@csrf
                                                        <a class="btn btn-sm btn-icon btn-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="#">
                                                            <span class="btn-inner">
                                                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M11.4925 2.78906H7.75349C4.67849 2.78906 2.75049 4.96606 2.75049 8.04806V16.3621C2.75049 19.4441 4.66949 21.6211 7.75349 21.6211H16.5775C19.6625 21.6211 21.5815 19.4441 21.5815 16.3621V12.3341" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
