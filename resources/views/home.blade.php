                ...
                <div class="col-xl-12 col-lg-12 dish-card-horizontal mt-2">
                    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 row-cols-xxl-4">
                        <div class="col active">
                            <div class="card card-white dish-card profile-img mb-0 index">
                                <div class="profile-img21">
                                    <img src="../assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom" alt="profile-image" />
                                    <img src="../assets/images/layouts/16.png" class="img-fluid rounded-pill avatar-170" alt="profile-image" />
                                </div>
                        ...
                        <div class="col">
                            <div class="card card-white dish-card profile-img mb-0 index">
                                <div class="profile-img21">
                                    <img src="../assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom" alt="profile-image" />
                                    <img src="../assets/images/layouts/15.png" class="img-fluid rounded-pill avatar-170" alt="profile-image" />
                                </div>
                                <div class="card-body menu-image">
                        ...
                        <div class="col">
                            <div class="card card-white dish-card profile-img mb-0 active">
                                <div class="profile-img21">
                                    <img src="../assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom" alt="profile-image" />
                                    <img src="../assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-170" alt="profile-image" />
                                </div>
                                <div class="card-body menu-image">
                        ...
                        <div class="col">
                            <div class="card card-white dish-card profile-img mb-0 index">
                                <div class="profile-img21">
                                    <img src="../assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170 blur-shadow position-bottom" alt="profile-image" />
                                    <img src="../assets/images/layouts/12.png" class="img-fluid rounded-pill avatar-170" alt="profile-image" />
                                </div>
                                <div class="card-body menu-image">
                        ...
                        <div class="swiper-slide">
                                ...
                                <div class="card-body">
                                    <div class="d-flex profile-img1">
                                        <div class="profile-img31">
                                            <img src="../assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image" />
                                            <img src="../assets/images/layouts/17.png" class="img-fluid rounded-pill avatar-130" alt="profile-image" />
                                        </div>
                                        <div>
                                            <span class="text-primary">
                                                <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card card-white dish-card2 index">
                                <div class="card-body">
                                    <div class="d-flex profile-img1">
                                        <div class="profile-img31">
                                            <img src="../assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image" />
                                            <img src="../assets/images/layouts/19.png" class="img-fluid rounded-pill avatar-130" alt="profile-image" />
                                        </div>
                                        <div>
                                            <span class="text-primary">
                                                <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-white dish-card2 index">
                                <div class="card-body">
                                    <div class="d-flex profile-img1">
                                        <div class="profile-img31">
                                            <img src="../assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image" />
                                            <img src="../assets/images/layouts/14.png" class="img-fluid rounded-pill avatar-130" alt="profile-image" />
                                        </div>
                                        <div>
                                            <span class="text-primary">
                                                <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card card-white dish-card2 active">
                                <div class="card-body">
                                    <div class="d-flex profile-img1">
                                        <div class="profile-img31">
                                            <img src="../assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image" />
                                            <img src="../assets/images/layouts/20.png" class="img-fluid rounded-pill avatar-130" alt="profile-image" />
                                        </div>
                                        <div>
                                            <span class="text-primary">
                                                <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-white dish-card2 index">
                                <div class="card-body">
                                    <div class="d-flex profile-img1">
                                        <div class="profile-img31">
                                            <img src="../assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image" />
                                            <img src="../assets/images/layouts/18.png" class="img-fluid rounded-pill avatar-130" alt="profile-image" />
                                        </div>
                                        <div>
                                            <span class="text-primary">
                                                <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card card-white dish-card2 index">
                                <div class="card-body">
                                    <div class="d-flex profile-img1">
                                        <div class="profile-img31">
                                            <img src="../assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130 blur-shadow position-start" alt="profile-image" />
                                            <img src="../assets/images/layouts/21.png" class="img-fluid rounded-pill avatar-130" alt="profile-image" />
                                        </div>
                                        <div>
                                            <span class="text-primary">
                                                <svg width="20" height="15" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="d-flex align-items-center profile-content">
                                    <div>
                                        ...
                                        <span class="d-flex align-items-center">
                                            ...
                                            <small class="text-dark ms-1">1</small>
                                        </span>
                                    </div>
                                </div>
