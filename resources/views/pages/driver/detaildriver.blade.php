          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="text-md-right">
                <form method="POST" action="{{ route('deliveryConfirm', $orderlist_id) }}"> @csrf
                  <div class="float-lg-left mb-lg-0 mb-3">
                    <a href="{{route('driver_page')}}" class="btn btn-info btn-icon icon-left"><i class="fas fa-arrow-left"></i> Back to Driver Page</a>
                  </div>
                  <div class="float-lg-left mb-lg-0 mb-3 ml-2">
                      <button type="submit" class="btn btn-primary btn-icon icon-left"><i class="fas fa-credit-card"></i>Confirm Delivery</button>
                  </div>
                </form>
              </div>
            </div>
